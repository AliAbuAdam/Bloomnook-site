...
export interface Product {
   ...
   * добавляется на витрине автоматически, если не отключена (`packsOnly`).
   * [] — только поштучно.
   */
  packs: number[];
  /** true — товар продаётся только комплектами, без поштучной продажи. */
  packsOnly: boolean;
  tile: string;
}
...
export const steps: Step[] = [
  ...
  { n: "02", t: "Оформите заказ", d: "Добавьте луковицы в корзину и оплатите заказ прямо на сайте — удобно и безопасно." },
  { n: "03", t: "Получите посылку", d: "Луковицы доставит «OZON Доставка» — в защитной упаковке, с памяткой по посадке для вашего сорта." },
